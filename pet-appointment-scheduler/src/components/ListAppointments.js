                ...
                <div className="pet-item col media py-3" key={item.aptId}>
                    ...
                    <div className="pet-info media-body">
                        <div className="pet-head d-flex">
                            ...
                            >{item.petName}</span>
                            <span className="apt-date ml-auto" contentEditable suppressContentEditableWarning
                            onBlur={e => this.props.updateInfo('aptDate', e.target.innerText, item.aptId)}>
                                <Moment date={item.aptDate} parse={"YYYY-MM-DD hh:mm"} format={"MMM-D-Y h:mma"}/></span>
                        </div>
